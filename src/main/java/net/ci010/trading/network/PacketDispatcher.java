...
public class PacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(TradingMod.MODID);
	...
	@SuppressWarnings(
	{ "rawtypes", "unchecked" })
	public static final void registerMessage(Class handlerClass, Class<? extends IMessage> messageClass, Side side)
	{
